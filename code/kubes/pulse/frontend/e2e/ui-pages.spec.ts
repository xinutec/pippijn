...
/**
 * Phone-width layout checks for pulse (Pixel 7, 412px). Every screen: no text
 ...
 * that fixed.
 *
 * pulse fetches via httpResource; the backend is mocked with busy fixtures so
...
const PROBLEMS = {
  checks: [
    ...
    },
    {
      ...
      subject: 'xinutec/pulse', verdict: 'fail', observed: 'sha 9dc8fec', expected: 'sha f335fb2',
