...
/// The wire schema version pulse currently accepts. Bumped only on a
...
// --- upload (producer → pulse). Deserialize only; producers aren't TS. ---
...
// --- responses (pulse → UI). Serialize + TS. ---
