# pulse web viewer (Android)

The `pulse.xinutec.org` fleet monitoring dashboard presented as a native-feeling
...
- Loads `https://pulse.xinutec.org/` — **hardcoded** (`MainActivity.PULSE_URL`);
...
│       ├── kotlin/org/xinutec/pulse/MainActivity.kt   # the WebView (+ inset padding)
