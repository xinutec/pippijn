...
/**
 * A full-screen [WebView] onto pulse — the fleet monitoring dashboard, an Angular
 * app served at [PULSE_URL]. No address bar, no tabs, a home-screen icon: the
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        web.loadUrl(prefs.getString(KEY_LAST_URL, null) ?: PULSE_URL)
    }
    ...
    companion object {
        // The pulse dashboard (HTTPS, VPN-only, no login).
        private const val PULSE_URL = "https://pulse.xinutec.org/"
