...
describe("API: authentication", () => {
  it("returns 401 for all endpoints without session", async () => {
    ...
    const endpoints = [
      "/api/me", "/api/activity", "/api/sleep", "/api/heartrate/zones",
      "/api/heartrate/intraday", "/api/body", "/api/spo2", "/api/hrv",
      "/api/breathing", "/api/temperature", "/api/devices", "/api/sync-state",
    ];
