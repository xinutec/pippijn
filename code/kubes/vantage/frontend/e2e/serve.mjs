...
// run. Serves dist/vantage-web/browser with SPA fallback to index.html, and the
...
const ROOT = join(fileURLToPath(new URL('.', import.meta.url)), '..', 'dist', 'vantage-web', 'browser');
