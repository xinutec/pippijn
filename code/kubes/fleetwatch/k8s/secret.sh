...
#
# ⚠ READ THE LIVE SOURCES FROM THE LIVE SECRET, never from memory or from this
# file: a producer joins whenever a host starts pushing, so any written list
# drifts behind. It matters BECAUSE of the sentence below — re-running with a
# stale list silently DEAUTHORISES every producer it omits. This script REGENERATES EVERYTHING — DB
